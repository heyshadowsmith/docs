...
export const meta = {
  ...
  lastEdited: '2020-07-22T22:37:24.000Z'
}
...
<Snippet dark prompt={false} copyText="https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world" text={<span style={{color: "var(--accents-3)"}}>https://vercel.com/import/git?<b style={{color: "var(--geist-background)"}}>s=https://github.com/vercel/next.js/tree/canary/examples/hello-world</b></span>}/>
...
<Snippet dark prompt={false} copyText="https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world&env=PUBLIC_API_KEY,API_SECRET_KEY" text={<span style={{color: "var(--accents-3)"}}>https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world&amp;<b style={{color: "var(--geist-background)"}}>env=PUBLIC_API_KEY,API_SECRET_KEY</b></span>}/>
...
<Snippet
  dark
  prompt={false}
  copyText="https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world&env=PUBLIC_API_KEY&envDescription=Enter%20your%20public%20API%20Key."
  text={
    <span style={{ color: 'var(--accents-3)' }}>
      https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world&amp;env=PUBLIC_API_KEY,API_SECRET_KEY&amp;
...
<Snippet dark prompt={false} copyText="https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world&env=PUBLIC_API_KEY&envDescription=Enter%20your%20public%20API%20Key.&envLink=https://vercel.com/docs" text={<span style={{color: "var(--accents-3)"}}>https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world&amp;env=PUBLIC_API_KEY,API_SECRET_KEY&amp;envDescription=Enter%20your%20public%20API%20Key.&amp;<b style={{color: "var(--geist-background)"}}>envLink=https://vercel.com/docs</b></span>}/>
...
<Snippet dark prompt={false} copyText="https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world&redirect-url=my-headless-application.com" text={<span style={{color: "var(--accents-3)"}}>https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world&amp;<b style={{color: "var(--geist-background)"}}>redirect-url=my-headless-application.com</b></span>}/>
...
<Snippet dark prompt={false} copyText="https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world&redirect-url=my-headless-application.com&developer-id=oac_7rUTiCMow23Gyfao9RQQ3Es2" text={<span style={{color: "var(--accents-3)"}}>https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world&amp;redirect-url=my-headless-application.com&amp;<b style={{color: "var(--geist-background)"}}>developer-id=oac_7rUTiCMow23Gyfao9RQQ3Es2</b></span>} />
...
<Snippet dark prompt={false} copyText="https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world&redirect-url=my-headless-application.com&production-deploy-hook=MyHeadlessProject" text={<span style={{color: "var(--accents-3)"}}>https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world&amp;redirect-url=my-headless-application.com&amp;<b style={{color: "var(--geist-background)"}}>production-deploy-hook=MyHeadlessProject</b></span>} />
...
<Snippet dark prompt={false} copyText="https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world&project-name=my-awesome-project" text={<span style={{color: "var(--accents-3)"}}>https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world&amp;redirect-url=my-headless-application.com&amp;<b style={{color: "var(--geist-background)"}}>project-name=my-awesome-project</b></span>}/>
...
<Snippet dark prompt={false} copyText="https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world&repository-name=my-awesome-project" text={<span style={{color: "var(--accents-3)"}}>https://vercel.com/import/git?s=https://github.com/vercel/next.js/tree/canary/examples/hello-world&amp;redirect-url=my-headless-application.com&amp;<b style={{color: "var(--geist-background)"}}>repository-name=my-awesome-project</b></span>}/>
